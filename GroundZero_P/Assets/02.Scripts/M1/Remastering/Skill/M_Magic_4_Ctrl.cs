...
/// <summary>
/// 작성자                 JSH
/// Monster Magic_4 Control
/// 마법 4 발사체 컨트롤. 앞을 향해 발사된다.
/// 
/// *코멘트
///     <<추가완료>>  오브젝트 풀 사용
/// </summary>
...
public class M_Magic_4_Ctrl : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        {
            //필요한 정보 수집
            traceSpeed = M_Magic_4.instance.magic_4_TraceSpeed;
            speed = M_Magic_4.instance.magic_4_Speed;
            delayTime = M_Magic_4.instance.magic_4_ShootDelayTime;
            maxDist = M_Magic_4.instance.magic_4_MaxDist;

            isStart = true;
        }
        else
        {
            StartCoroutine(this.ShootMagic_4());            //마법 4 발사
        }
    }
    ...
    IEnumerator CheckDist()
    {
        while (true)
        {
            //발사 시작 지점에서 일정 거리 이상 멀어지면 마법 4 비활성화
