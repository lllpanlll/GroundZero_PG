...
public class M_BodyPress : M_Skill
{
    ...
    public Vector3 bodyPressFloorScale = new Vector3(25.0f, 1.0f, 25.0f);       //바디 프레스 장판 콜리더 크기
    ...
    public override IEnumerator UseSkill(Vector3 target)
    {
        ...
        bodyPressFloor.GetComponent<Transform>().localScale = bodyPressFloorScale;  //원하는 사이즈로 확대
        ...
        bodyPressFloor.GetComponentInChildren<M_AttackCtrl>().SetAttackProperty(skillStatus.damage, false);
